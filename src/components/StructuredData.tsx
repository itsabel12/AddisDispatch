    ...
    "@graph": [
      ...
      },
      {
        ...
        offers: [
          ...
          { "@type": "Offer", name: "Professional", description: "Up to 3 trucks", price: "7", priceCurrency: "USD", unitText: "percent of gross" },
          { "@type": "Offer", name: "Fleet", description: "4–10 trucks", price: "6", priceCurrency: "USD", unitText: "percent of gross" },
        ],
      },
      {
        "@type": "FAQPage",
