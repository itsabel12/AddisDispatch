...
export const faqs: Faq[] = [
  {
    ...
    a: "We charge 8–10% of the gross load rate depending on fleet size and plan. Solo operators pay 8% and Professional accounts (up to 3 trucks) pay 10%. No hidden fees, no minimums.",
  },
  {
